...
export default function EditListingPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (error) {
    return <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="bg-gray-900/30 backdrop-blur-sm rounded-3xl p-8 border border-red-500/30 max-w-md">
        <div className="flex items-center space-x-4 mb-4">
          <svg className="w-8 h-8 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
          </svg>
          <h2 className="text-xl font-light text-white">Error</h2>
        </div>
  ...
  if (!listing) {
    return <div className="min-h-screen bg-black flex items-center justify-center">
      <div className="bg-gray-900/30 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50 max-w-md text-center">
        ...
        <h2 className="text-xl font-light text-white mb-2">Listing Not Found</h2>
        <p className="text-gray-400 mb-6">The listing you're looking for doesn't exist or has been removed.</p>
        <Link 
          href="/listings"
          className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-2xl text-sm font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
        >
          Browse Listings
        </Link>
      </div>
